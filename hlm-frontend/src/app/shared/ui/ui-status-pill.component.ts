...
export class UiStatusPillComponent {
  ...
  private static readonly PALETTE: Record<string, { bg: string; fg: string }> = {
    ...
    // Pipeline / vente (VEFA, Loi 44-00)
    PROSPECT:            { bg: '#f1f5f9', fg: '#475569' },
    OPTION:              { bg: '#e0f2fe', fg: '#0369a1' },
    EN_RETRACTATION:     { bg: '#fef9c3', fg: '#a16207' },
    ACOMPTE:             { bg: '#e0f2fe', fg: '#0369a1' },
    COMPROMIS:           { bg: '#dcfce7', fg: '#15803d' },
    FINANCEMENT:         { bg: '#fef9c3', fg: '#a16207' },
    ACTE:                { bg: '#dbeafe', fg: '#1d4ed8' },
    ACTE_NOTARIE:        { bg: '#dbeafe', fg: '#1d4ed8' },
    LIVRE_AVEC_RESERVES: { bg: '#fef9c3', fg: '#a16207' },
    RESERVES_LEVEES:     { bg: '#dbeafe', fg: '#1d4ed8' },
    LIVRE_DEFINITIF:     { bg: '#dbeafe', fg: '#1d4ed8' },
