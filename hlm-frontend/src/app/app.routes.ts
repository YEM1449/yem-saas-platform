...
export const routes: Routes = [
  ...
  { path: 'activation', loadComponent: () => import('./features/activation/activation.component').then(m => m.ActivationComponent) },
  {
    ...
    children: [
      ...
      { path: 'immeubles', loadComponent: () => import('./features/immeubles/immeubles.component').then(m => m.ImmeublesComponent) },
      { path: 'reservations', loadComponent: () => import('./features/reservations/reservations.component').then(m => m.ReservationsComponent) },
      { path: 'reservations/:id', loadComponent: () => import('./features/reservations/reservation-detail.component').then(m => m.ReservationDetailComponent) },
      ...
      { path: 'reports/ventes',   loadComponent: () => import('./features/reports/ventes-report.component').then(m => m.VentesReportComponent) },
      { path: 'reports/agents',   loadComponent: () => import('./features/reports/agents-report.component').then(m => m.AgentsReportComponent) },
      { path: 'reports/creances', loadComponent: () => import('./features/reports/creances-report.component').then(m => m.CreancesReportComponent) },
    ...
    children: [
      ...
      { path: 'verify', loadComponent: () => import('./portal/features/portal-verify/portal-verify.component').then(m => m.PortalVerifyComponent) },
      {
        ...
        children: [
          ...
          { path: 'ventes', loadComponent: () => import('./portal/features/portal-ventes/portal-ventes.component').then(m => m.PortalVentesComponent) },
